...
namespace Opus.Content.OpusBook
{
    ...
    public class OpusBookUI : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            nextButton = new UIImageButton(ModContent.Request<Texture2D>($"{OpusAssets.TexturePath}/ArrowRight"));
            ...
            prevButton = new UIImageButton(ModContent.Request<Texture2D>($"{OpusAssets.TexturePath}/ArrowLeft"));
            ...
            CloseButton = new UIImageButton(ModContent.Request<Texture2D>($"{OpusAssets.TexturePath}/CloseButton"));
        ...
        {
            SoundEngine.PlaySound(OpusAssets.PageTurn, Main.LocalPlayer.position);
